...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Guowei Shieh"
...
#+BEGIN_SRC emacs-lisp
  (setq browse-url-browser-function 'browse-url-generic
        browse-url-generic-program "/Users/guoweishieh/.bin/chrome")
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun hrs/today-checklist-filename ()
    ...
    (concat "/Users/guoweishieh/Documents/checklists/daily-checklist-" (format-time-string "%Y-%m-%d") ".org"))
...
#+BEGIN_SRC emacs-lisp
  (load-file "~/.dotfiles/.emacs-private.el")
#+END_SRC
...
#+END_SRC
* MY Go binding
copied from [[http://tleyden.github.io/blog/2014/05/22/configure-emacs-as-a-go-editor-from-scratch/][this]]
...
copief from https://github.com/weijiangan/flycheck-golangci-lint
#+BEGIN_SRC emacs-lisp
...
# following [[https://emacs.cafe/emacs/javascript/setup/2017/04/23/emacs-setup-javascript.html][this page]]
...
# Copied from [[https://joshwolfe.ca/post/emacs-for-csharp/][here]]
...
(setq org-plantuml-jar-path
      (expand-file-name "~/.dotfiles/plantuml.jar"))
